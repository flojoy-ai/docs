...
const PieChartIcon = ({ ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#clip0_5_252)">
        <path d="M33.1034 3.78969L33.3298 34.8221L3.06199 26.7809C2.33893 29.4381 1.9554 32.2408 1.98055 35.1258C2.1063 52.3027 16.1839 66.1265 33.4304 66C33.4744 66 33.5121 66 33.5561 66C50.5511 65.5129 64.1195 51.6321 64 34.6702C63.8805 17.7084 50.1047 4.0301 33.1034 3.78969Z" />
        <g opacity="0.5">
          <path d="M0 22.9532L30.2615 31.121L30.0352 0C15.6432 0.107554 3.59642 9.81902 0 22.9532Z" />
        </g>
      </g>
      <defs>
