...
const UniversalAdmonition = () => {
    return (
        <div class="universal-admonition theme-admonition theme-admonition-info alert alert--info admonition_node_modules-@docusaurus-theme-classic-lib-theme-Admonition-styles-module">
            ...
            <div class="admonitionContent_node_modules-@docusaurus-theme-classic-lib-theme-Admonition-styles-module">
                <details class="details_node_modules-@docusaurus-theme-common-lib-components-Details-styles-module isBrowser_node_modules-@docusaurus-theme-common-lib-components-Details-styles-module alert alert--info details_node_modules-@docusaurus-theme-classic-lib-theme-Details-styles-module" data-collapsed="true">
                    <summary><i>Flojoy is a free, open-source replacement for engineering software such as LabVIEW and Simulink.</i></summary>
                    <div>
                        <div class="collapsibleContent_node_modules-@docusaurus-theme-common-lib-components-Details-styles-module">
                            <ol>
