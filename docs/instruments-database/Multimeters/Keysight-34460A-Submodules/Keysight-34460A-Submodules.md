---
title: Connecting to Keysight (Agilent) 34460A Submodules by Keysight (Agilent) in Python
sidebar_label: Keysight (Agilent) 34460A Submodules
...
## Connect to the Keysight (Agilent) 34460A Submodules in Python
...
To connect to a Keysight (Agilent) 34460A Submodules Multimeter using Qcodes, you can use the following Python script:
...
Make sure to replace `'your_device_address'` with the actual address of your Keysight (Agilent) 34460A Submodules Multimeter.
