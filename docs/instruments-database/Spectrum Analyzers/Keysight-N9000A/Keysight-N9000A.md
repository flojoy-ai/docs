---
title: Connecting to Keysight (Agilent) N9000A by Agilent in Python
sidebar_label: Keysight (Agilent) N9000A
...
## Connect to the Keysight (Agilent) N9000A in Python
...
To connect to a Keysight (Agilent) N9000A Spectrum Analyzer using Qcodes Community, you can use the following Python script:
...
# Connect to the Keysight (Agilent) N9000A Spectrum Analyzer
...
Note: Replace `'TCPIP0::192.168.1.1::inst0::INSTR'` with the actual IP address or VISA resource string of your Keysight (Agilent) N9000A Spectrum Analyzer.
