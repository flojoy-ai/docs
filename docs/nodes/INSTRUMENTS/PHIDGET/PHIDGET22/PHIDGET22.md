---
title: PHIDGET22
description: Efficiently control Phidget22 instruments using Python. Declaration of the Event handler, print Voltage variation for a channel.
...
<PythonCode GLink='INSTRUMENTS/PHIDGET/PHIDGET22/PHIDGET22.py'>{PythonSource}</PythonCode>
...
[Edit page here](https://github.com/flojoy-ai/docs/tree/main/docs/nodes/INSTRUMENTS/PHIDGET/PHIDGET22)
