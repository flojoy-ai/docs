---
title: SAVGOL
description: Apply a Savitzky-Golay filter to an input signal, it's generally used for smoothing data. The default behaviour is implementing a 3-point moving average of the data.
