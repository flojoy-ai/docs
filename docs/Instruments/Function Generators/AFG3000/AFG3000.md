...
<img src="https://res.cloudinary.com/dhopxs1y3/image/upload/e_bgremoval/v1692118735/Instruments/Function%20Generators/AFG3000/AFG3000.png" style={{ width: "325px", height: "200px" }} />
...
This script creates a `Station` object to hold the instruments. It then connects to the AFG3000 Function Generator using the `AFG3000` driver and adds it to the station. The available parameters of the AFG3000 can be accessed through the `parameters` attribute. The script sets the trigger mode to 'TRIG' and the output impedance of channel 1 to 50 Ohm. It also sets the amplitude modulation depth of channel 2 to 10%. Finally, it closes the connection to the instruments.
