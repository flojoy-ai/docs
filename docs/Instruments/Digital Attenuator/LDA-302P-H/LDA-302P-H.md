...
<img src="https://res.cloudinary.com/dhopxs1y3/image/upload/v1692078064/Instruments/Digital%20Attenuator/LDA-302P-H/LDA-302P-H.png" style={{ width: "325px" }} />
...
To connect to a LDA-302P-H using Qcodes Community, you can use the following Python script:
...
Make sure to replace `'path/to/dll'` with the actual path to the DLL file for the LDA-302P-H.
