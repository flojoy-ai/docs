...
slug: /instruments-wiki/rf-signal-generator/tektronix/awg70002b
image: https://res.cloudinary.com/dhopxs1y3/image/upload/e_bgremoval/v1692201339/Instruments/RF%20Signal%20Generator/AWG70002B/file.png
---
...
<img src="https://res.cloudinary.com/dhopxs1y3/image/upload/e_bgremoval/v1692201339/Instruments/RF%20Signal%20Generator/AWG70002B/file.png" style={{ width: "325px" }} />
...
# You can also set the amplitude of a specific channel
awg.channels.ch1.awg_amplitude(0.5)

# Play the waveform on the AWG
awg.play()
...
Note that you need to replace `'TCPIP0::192.168.1.1::inst0::INSTR'` with the actual VISA resource name or IP address of your AWG70002B RF Signal Generator.
