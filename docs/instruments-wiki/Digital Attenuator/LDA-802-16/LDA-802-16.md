...
slug: /instruments-wiki/digital-attenuator/vaunix/lda-802-16
image: https://res.cloudinary.com/dhopxs1y3/image/upload/e_bgremoval/v1692106987/Instruments/Digital%20Attenuator/LDA-802-16/file.png
---
...
<img src="https://res.cloudinary.com/dhopxs1y3/image/upload/e_bgremoval/v1692106987/Instruments/Digital%20Attenuator/LDA-802-16/file.png" style={{ width: "325px" }} />
...
This script creates a `Station` object to hold the instruments. It then connects to the LDA-802-16 Digital Attenuator using the `LDA` driver from the `qcodes_contrib_drivers` package. The LDA is added to the station, and its IDN information is printed. The attenuation on channel 1 is set to 10 dB, and finally, the connection to the LDA is closed.
