...
slug: /instruments-wiki/digital-attenuator/vaunix/lda-602
image: https://res.cloudinary.com/dhopxs1y3/image/upload/v1692107108/Instruments/Digital%20Attenuator/LDA-602/file.png
---
...
<img src="https://res.cloudinary.com/dhopxs1y3/image/upload/v1692107108/Instruments/Digital%20Attenuator/LDA-602/file.png" style={{ width: "325px" }} />
...
Make sure you have the necessary DLL files (`VNX_atten64.dll` for 64-bit Windows or `VNX_atten.dll` for 32-bit Windows) in the appropriate directory and that the `Vaunix_LDA` driver is installed.
